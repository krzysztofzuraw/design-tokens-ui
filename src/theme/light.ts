...
export const lightTheme = {
  ...
  "--color-neutral-text-primary": "hsla(211, 42%, 16%, 1)",
  "--color-neutral-text-secondary": "hsla(210, 13%, 56%, 1)",
  "--color-neutral-text-tertiary": "hsla(210, 10%, 56%, 1)",
  "--color-neutral-page-background": "hsla(0, 0%, 100%, 1)",
  "--color-neutral-element-active-Background": "hsla(220, 18%, 97%, 1)",
  "--color-neutral-element-inactivebackground": "hsla(0, 0%, 100%, 1)",
  "--color-neutral-border-active": "hsla(211, 42%, 16%, 0.12)",
  "--color-neutral-border-inactive": "hsla(210, 15%, 87%, 1)",
  "--color-brand-text-primary": "hsla(215, 96%, 43%, 1)",
  "--color-brand-element-primary-background": "hsla(214, 70%, 92%, 1)",
